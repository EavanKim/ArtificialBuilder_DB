...
namespace ArtificialBuilder
{
    ...
    public sealed class AB_Template_Add_Circuit_Payload
    {
    ...
    public sealed class AB_Template_Delete_Circuit_Payload
    {
        private AB_Response_Ui_Template_Model? m_template_;
        public AB_Response_Ui_Template_Model? Template_ { get => m_template_; set => m_template_ = value; }
    }

    public sealed class AB_Template_Save_Circuit_Payload
    {
        private AB_Response_Ui_Template_Model? m_template_;
        public AB_Response_Ui_Template_Model? Template_ { get => m_template_; set => m_template_ = value; }
    }

    public sealed class AB_Template_Set_Active_Circuit_Payload
    {
        private string m_templateId_ = "";
        public string TemplateId_ { get => m_templateId_; set => m_templateId_ = value; }
    }

    public sealed class AB_Template_Import_From_Global_Payload
    {
    ...
    public sealed class AB_Template_Get_All_Circuit_Result
    {
    ...
    public sealed class AB_Template_Get_All_Global_Result
    {
    ...
    public sealed class AB_Template_Add_Circuit_Result
    {
        private bool m_ok_;
        public bool Ok_ { get => m_ok_; set => m_ok_ = value; }
    }

    public sealed class AB_Template_Delete_Circuit_Result
    {
        private bool m_ok_;
        public bool Ok_ { get => m_ok_; set => m_ok_ = value; }
    }

    public sealed class AB_Template_Save_Circuit_Result
    {
        private bool m_ok_;
        public bool Ok_ { get => m_ok_; set => m_ok_ = value; }
    }

    public sealed class AB_Template_Set_Active_Circuit_Result
    {
        private bool m_ok_;
        public bool Ok_ { get => m_ok_; set => m_ok_ = value; }
    }

    public sealed class AB_Template_Import_From_Global_Result
    {
        private bool m_ok_;
        public bool Ok_ { get => m_ok_; set => m_ok_ = value; }
    }
